...
class TestLambdaEOS:
    ...
    def test_avionics_interface(self):
        ...
        expected = INTERFACE_EOS_VALUES["Avionics"]["pi_i"] * INTERFACE_EOS_VALUES["Avionics"]["l_eos"]
...
class TestCalculateComponentLambda:
    ...
    def test_ic_dispatch(self):
        ...
        result = calculate_component_lambda("Integrated Circuit", {
    ...
    def test_resistor_dispatch(self):
        ...
        result = calculate_component_lambda("Resistor", {
            "resistor_type": "SMD Chip Resistor",
            "t_ambient": 25.0,
            "operating_power": 0.01,
            "rated_power": 0.125
    ...
    def test_capacitor_dispatch(self):
        ...
        result = calculate_component_lambda("Capacitor", {
            "capacitor_type": "Ceramic Class II (X7R/X5R)",
            "t_ambient": 25.0
        })
