...
IEC TR 62380:2004 reliability analysis tool for KiCad with visual block diagram editor.
...
- **System Modelling**: Series, parallel, and K-of-N redundancy configurations
...
- **Working Time Ratio (tau_on)**: Support for duty-cycled operation (0-1)
- **Thermal Expansion**: Selectable substrate and package materials
- **Corrected pi_n Threshold**: Proper 8760 cycles/year discontinuity handling
...
### Thermal Expansion (alpha, ppm/degC)
| Substrate | alpha |
|-----------|-------|
...
- **v2.0.0**: New EOS configuration, tau_on support, thermal expansion, corrected pi_n
